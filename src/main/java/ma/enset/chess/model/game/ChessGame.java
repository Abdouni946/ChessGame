...
import ma.enset.chess.model.game.pieces.*;
...
import static ma.enset.chess.model.util.Constants.SIZE_OF_CHESS_BOARD;
import static ma.enset.chess.model.util.Constants.initialState;
...
public class ChessGame implements ChessGameInterface {
    ...
    private int getPositionalValue(int row, int col, Pieces piece) {
        if (piece == null || piece == Pieces.WHITE_KING || piece == Pieces.BLACK_KING)
            return 0;
    ...
    private void setUpPieceTablesMap() {
        ...
        pieceTables.put(Pieces.WHITE_QUEEN, QUEEN_PIECE_SQUARE);
        pieceTables.put(Pieces.BLACK_QUEEN, reverse(QUEEN_PIECE_SQUARE));

        pieceTables.put(Pieces.WHITE_ROOK, ROOK_PIECE_SQUARE);
        pieceTables.put(Pieces.BLACK_ROOK, reverse(ROOK_PIECE_SQUARE));

        pieceTables.put(Pieces.WHITE_BISHOP, BISHOP_PIECE_SQUARE);
        pieceTables.put(Pieces.BLACK_BISHOP, reverse(BISHOP_PIECE_SQUARE));

        pieceTables.put(Pieces.WHITE_KNIGHT, KNIGHT_PIECE_SQUARE);
        pieceTables.put(Pieces.BLACK_KNIGHT, reverse(KNIGHT_PIECE_SQUARE));

        pieceTables.put(Pieces.WHITE_PAWN, PAWN_PIECE_SQUARE);
        pieceTables.put(Pieces.BLACK_PAWN, reverse(PAWN_PIECE_SQUARE));
    }
