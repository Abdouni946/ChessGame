...
import ma.enset.chess.presenter.BoardPresenter;
import ma.enset.chess.presenter.TilePresenter;
...
public class TileNode extends StackPane implements Observer {
    ...
    public Image getImage(Pieces piece) {
        String path = "file:./src/main/java/ma/enset/chess/view/resources/";
